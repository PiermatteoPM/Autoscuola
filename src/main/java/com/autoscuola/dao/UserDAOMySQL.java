...
import com.autoscuola.query.QueryLogin;

import com.autoscuola.view.first.utils.GenreManager;
...
public class UserDAOMySQL implements UserDAO {
    ...
    public void insertUser(Login registration) throws EmailAlreadyInUseException, UsernameAlreadyInUseException {
    ...
    public User loadUser(Login login) throws UserDoesNotExistException {
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                amministratore = resultSet.getBoolean(AMMINISTRATORE);
            } else {
        ...
        if(amministratore){
            return new Amministratore(username,email,preferences);
    ...
    public Client retrieveClientByUsername(String username) throws UserDoesNotExistException {
        ...
        if(amministratore){
            return new Amministratore(username,email);
        } else {
            return new User(username,email,preferences);
        }
    }
